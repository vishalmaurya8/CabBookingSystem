...
builder.Services.AddDbContext<CarBookingSystemCbsContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("CabBookingSystemConnection")));
